defmodule TestGenServerWeb.PersonLive.Index do
  use TestGenServerWeb, :live_view

  alias TestGenServer.People
  ...
  @impl true
  def handle_info({TestGenServerWeb.PersonLive.FormComponent, {:saved, person}}, socket) do
