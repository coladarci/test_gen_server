defmodule TestGenServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestGenServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestGenServerWeb.Gettext, "errors", msg, opts)
    end
  end
